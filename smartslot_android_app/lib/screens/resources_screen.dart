  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        for (final r in data) { if (r['category'] != null) cats.add(r['category']); }
        setState(() { _resources = data; _categories = cats.toList(); _applyFilter(); });
      } else { setState(() => _error = 'Failed to load resources'); }
    } catch (e) { setState(() => _error = 'Connection error. Is the server running?'); }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(icon: const Icon(Icons.refresh, color: AppColors.textMuted), onPressed: _load),
        ],
      ),
          ...
          child: ListView.builder(
            ...
            itemBuilder: (ctx, i) {
              ...
              return Padding(
                ...
                child: FilterChip(
                  label: Text(cat), selected: selected,
                  onSelected: (_) => setState(() { _category = cat; _applyFilter(); }),
        ...
        Expanded(
          child: _loading
              ...
              : _error != null
                  ...
                  : _filtered.isEmpty
                      ? Center(child: Text('No resources found', style: Theme.of(context).textTheme.bodyMedium))
                      : RefreshIndicator(
