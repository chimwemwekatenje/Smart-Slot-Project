...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (auth.isExternal) {
      tabs = [const ResourcesScreen(), const MyBookingsScreen(), const ProfileScreen()];
      navItems = const [
      ...
      tabs = [const ResourcesScreen(), const MyBookingsScreen(), const OrgPanelScreen(), const ProfileScreen()];
      navItems = const [
        BottomNavigationBarItem(icon: Icon(Icons.grid_view_rounded), label: 'Resources'),
        BottomNavigationBarItem(icon: Icon(Icons.calendar_today_outlined), label: 'My Bookings'),
        BottomNavigationBarItem(icon: Icon(Icons.business_outlined), label: 'Org Panel'),
        BottomNavigationBarItem(icon: Icon(Icons.person_outline), label: 'Profile'),
      ];
    } else {
      tabs = [const ResourcesScreen(), const MyBookingsScreen(), const ProfileScreen()];
