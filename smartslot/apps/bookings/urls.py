...
from .views import (
    BookingListView, internal_booking_view, external_booking_view,
    booking_receipt_view, booking_pdf_view, cancel_booking_view,
    refund_policy_view,
)
...
urlpatterns = [
    ...
    path('<int:booking_id>/receipt/view/', booking_receipt_view, name='booking_receipt'),
