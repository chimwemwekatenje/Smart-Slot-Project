...
from .views import (
    ...
    DashboardOrganisationApplicationListView,
    SuperAdminAnalysisView,
    dashboard_users_view,
    dashboard_organisation_application_detail_view,
...
urlpatterns = [
    ...
    path('organisation-applications/',    DashboardOrganisationApplicationListView.as_view(), name='dashboard_org_applications'),
    path('organisation-applications/<int:pk>/', dashboard_organisation_application_detail_view, name='dashboard_org_application_detail'),
